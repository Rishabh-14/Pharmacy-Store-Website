          ...
          <div class="row">
            <div class="col-lg-4">
              ...
              <p>
                ...
                assumenda, delectus. Amet repellendus quidem, fugiat.
              </p>
            </div>
            <div class="col-lg-4">
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Assumenda iste aut, ut similique nobis ab?
              </p>
            </div>
            <div class="col-lg-4">
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Repudiandae nisi magni in fugit, ad laudantium.
              </p>
            </div>
          </div>
        </div>
              ...
              <div class="block-38 text-center">
                <div class="block-38-img">
                  <div class="block-38-header">
                    <img
                      src="resources/images/person_1.jpg"
            ...
            <div class="col-md-6 col-lg-4 mb-5">
              <div class="block-38 text-center">
                <div class="block-38-img">
                  <div class="block-38-header">
                    <img
                      src="resources/images/person_2.jpg"
                      alt="Image placeholder"
                      class="mb-4"
                    />
            ...
            <div class="col-md-6 col-lg-4 mb-5">
              <div class="block-38 text-center">
                <div class="block-38-img">
                  <div class="block-38-header">
                    <img
                      src="resources/images/person_3.jpg"
                      alt="Image placeholder"
                      class="mb-4"
                    />
            ...
            <div class="col-md-6 col-lg-4 mb-5">
              <div class="block-38 text-center">
                <div class="block-38-img">
                  <div class="block-38-header">
                    <img
                      src="resources/images/person_4.jpg"
                      alt="Image placeholder"
                      class="mb-4"
                    />
